...
forward_derivative_macro!(abs_f64, "{0}.signum()");
...
forward_derivative_macro!(ceil_f64, "1f64");
...
forward_derivative_macro!(floor_f64, "1f64");
...
forward_derivative_macro!(fract_f64, "1f64");
...
forward_derivative_macro!(recip_f64, "-1f64 / ({0}{0})");
...
forward_derivative_macro!(round_f64, "1f64");
