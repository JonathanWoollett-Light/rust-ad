...
reverse_derivative_macro!(add_f32, "0f32", "1f32", "1f32");
// Reverse deriative of [std::ops::Sub].
reverse_derivative_macro!(sub_f32, "0f32", "1f32", "-1f32");
// Reverse deriative of [std::ops::Mul].
reverse_derivative_macro!(mul_f32, "0f32", "{1}", "{0}");
// Reverse deriative of [std::ops::Div].
reverse_derivative_macro!(div_f32, "0f32", "1f32/{1}", "-{0}/({1}*{1})");
...
reverse_derivative_macro!(abs_f32, "0f32", "{0}.signum()");
// Reverse deriative of [`recip`](https://doc.rust-lang.org/std/primitive.f32.html#method.recip).
reverse_derivative_macro!(recip_f32, "0f32", "-1f32 / ({0}{0})");
