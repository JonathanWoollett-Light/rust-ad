...
mod reverse_operations {
    ...
    #[test]
    fn powi_test() {
        let (f, der_x, der_y) = reverse!(powi_fn, 3f32, 5f32);
        assert_eq!(f, 63.4f32);
    ...
    #[test]
    fn powf_test() {
        let (f, der_x, der_y) = reverse!(powf_fn, 3f32, 5f32);
        assert_eq!(f, 63.4f32);
        assert_eq!(der_x, 60f32);
        assert_eq!(der_y, -0.08f32);
    ...
    #[test]
    fn sqrt_test() {
        let (f, der_x, der_y) = reverse!(sqrt_fn, 3f32, 5f32);
    ...
    #[test]
    fn ln_test() {
        let (f, der_x, der_y) = reverse!(ln_fn, 3f32, 5f32);
    ...
    #[test]
    fn log_test() {
        let (f, der_x, der_y) = reverse!(log_fn, 3f32, 5f32);
